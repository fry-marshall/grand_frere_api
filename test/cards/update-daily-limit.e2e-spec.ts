...
describe('PUT /api/v1/cards/:code/daily-limit', () => {
  ...
  describe('Failure cases', () => {
    ...
    it('should return 403 when STUDENT is not allowed to edit the daily limit', async () => {
      await cardRepo.update(card.id, { studentCanEditDailyLimit: false });
      ...
      await cardRepo.update(card.id, { studentCanEditDailyLimit: true });
    });
